...
release_package() {
    ...
    scp $1-$2.tar.gz $SERVER_HOST:/var/www/downloads/terminal/modules/yunslave/$1
}

cecho "开始上传服务器!!!" $green

release_package yunslave-w67 $PRODUCT_VERSION_STRING_YUNSLAVE_W67
release_package yunslave-w323 $PRODUCT_VERSION_STRING_YUNSLAVE_W323
