...
"%ESP8266_TOOL%"  -v -cd nodemcu -cp %UPLOAD_PORT% -cb %UPLOAD_SPEED% -ca 0x00000 -cf boot-v2.bin -ca 0x14000 -cf firmware.bin -ca 0x3FC000 -cf blank.bin -ca 0x3FC000 -cf esp_init_data_default.bin -cr
