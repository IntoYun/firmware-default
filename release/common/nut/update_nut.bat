...
"%ESP8266_TOOL%"  -v -cd nodemcu -cp %UPLOAD_PORT% -cb %UPLOAD_SPEED% -ca 0x00000 -cf nut-boot.bin -ca 0x14000 -cf default-nut.bin -ca 0x114000 -cf default-nut.bin -ca 0x194000 -cf nut-boot.bin -ca 0x3FC000 -cf blank.bin -ca 0x3FC000 -cf esp_init_data_default.bin 
